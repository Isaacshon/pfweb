  ...
  return (
    <div className="min-h-screen bg-white pb-32">
      ...
      <section className="px-6 pt-20 pb-12 flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl font-black font-plus-jakarta tracking-tight mb-2">Test Account (for test.)</h1>
        <p className="text-brand-purple font-bold text-sm uppercase tracking-widest">PassionFruits Member (for test.)</p>
      </section>
      ...
      <section className="px-6 grid grid-cols-2 gap-4 mb-12">
        <div className="bg-slate-50 p-6 rounded-[40px] flex flex-col gap-1">
          ...
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Meditations (for test.)</p>
        </div>
        <div className="bg-slate-50 p-6 rounded-[40px] flex flex-col gap-1">
          ...
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Attendance (for test.)</p>
        </div>
      </section>

      {/* Activity Calendar Placeholder */}
      <section className="px-6 mb-12">
        <h2 className="text-xl font-black font-plus-jakarta mb-6">Weekly Activity (for test.)</h2>
        <div className="bg-white border border-slate-100 rounded-[40px] p-8 shadow-sm">
          ...
          <p className="text-center text-xs text-slate-400 font-medium">Activity (for test.)</p>
        </div>
      </section>
      ...
      <section className="px-6 flex flex-col gap-2">
        <button className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px] group active:scale-[0.98] transition-all">
          <div className="flex items-center gap-4">
            ...
            <span className="font-black text-sm">Account (for test.)</span>
          </div>
        ...
        <button className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px] group active:scale-[0.98] transition-all">
          <div className="flex items-center gap-4">
            ...
            <span className="font-black text-sm">Notification (for test.)</span>
          </div>
          <span className="material-icons text-slate-200">chevron_right</span>
        </button>
      </section>
